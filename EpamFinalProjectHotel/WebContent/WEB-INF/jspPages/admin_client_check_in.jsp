...
<fmt:message bundle="${loc}" key="check_in_title"
	var="check_in_title" />
<fmt:message bundle="${loc}" key="check_in_check"
	var="check_in_check" />
<fmt:message bundle="${loc}" key="check_in_new_client" 	var="check_in_new_client" />
...
<%-- 						<li>
	...
	<%-- 					<li>
		...
		<div class="view-account_big">
			<h2 class="title">${check_in_title}</h2>
			<div class="row">
				<div class="col-xs-12 col-sm-9">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								<form class="form-horizontal" action="mainPage" method="post">
									...
									<br/>
									<input type="submit" class = "form-control" value = "${check_in_check}"/>
								</form>
							</div>
						</div>
						<br/>
						<div class="panel-body">
							<div class="form-group">
								<form class="form-horizontal" action="mainPage" method="post">
									<input type="submit" class = "form-control" value = "${check_in_new_client}"/>
								</form>
							</div>
						</div>
					</div>
